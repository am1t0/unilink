...
const ProfilePage = ( {authUser, checkingAuth} ) => {
    ...
    <div className="profilePageContainer">
      ...
      <div className="profilePageLeft">
        ...
        <div className="profilePageDetails">
          <p>
            <GraduationCap size={40} style={{ paddingRight: "10px" }} />{" "}
            Institute of Engineering and Technology, DAVV
          </p>
          <p>
            <BookOpen size={30} style={{ paddingRight: "10px" }} /> B.E ,
            Information Technology
          </p>
          <p>
            <Phone size={30} style={{ paddingRight: "10px" }} /> xxxxxxxx91
          </p>
        </div>
      </div>
      ...
      <div className="profilePageRight">
        <div className="profilePageActions">
          ...
          <button>
            <Pencil size={16} /> Edit Your Profile
          </button>
        </div>
        ...
        <div className="profilePageConnections">
          ...
          <a href="#" className="profilePageSeeAll">
            See All
          </a>
        </div>
      </div>
